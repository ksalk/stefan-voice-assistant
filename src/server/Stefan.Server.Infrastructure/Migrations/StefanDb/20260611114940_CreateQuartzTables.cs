...
namespace Stefan.Server.Infrastructure.Migrations.StefanDb
{
    ...
    public partial class CreateQuartzTables : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"
                DROP TABLE IF EXISTS jobs.qrtz_locks;
                DROP TABLE IF EXISTS jobs.qrtz_scheduler_state;
                DROP TABLE IF EXISTS jobs.qrtz_fired_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_paused_trigger_grps;
                DROP TABLE IF EXISTS jobs.qrtz_calendars;
                DROP TABLE IF EXISTS jobs.qrtz_blob_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_simprop_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_cron_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_simple_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_triggers;
                DROP TABLE IF EXISTS jobs.qrtz_job_details;
